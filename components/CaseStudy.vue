  ...
  export default {
    ...
    mounted: function () {
        ...
        if ($(thisObj.$el).isInViewport()) {
          if (!thisObj.animated) {
            ...
            TweenMax.from($(thisObj.$el), 1, {
              ...
              ease: Power3.easeOut,
              onComplete: function () {
                TweenMax.to($(thisObj.$el).find('.wash'), .01, {
                  delay: .5,
                ...
                TweenMax.set($(thisObj.$el).find('img'), {
                  opacity: 1
                });
                TweenMax.to($(thisObj.$el).find('.header'), 1, {
                  delay: .5,
                  opacity: 1
                });
      ...
      function addListeners(tile, page) {
        ...
        tile.addEventListener("click", function (e) {
          ...
          if (thisObj.doneLoad) {
            ...
            TweenMax.to($(tile).find('.case-img')[0], .2, {
              autoAlpha: 0
            });
            TweenMax.to($(tile).find('.scroller-row')[0], .2, {
              autoAlpha: 0
            });
      ...
      function animateHero(fromHero, toHero) {
        ...
        TweenMax.to($(clone).find('img'), .2, {
          autoAlpha: 0
        });
        TweenMax.to($(clone).find('.scroller-row'), .2, {
          autoAlpha: 0
        });
        ...
        function onComplete() {
          ...
          setTimeout(() => thisObj.$router.push({
            name: 'works-' + thisObj.$parent.nextPage, params: { animation: 'fromHome' }
            //name: 'works-studio-eleven', params: { animation: 'fromHome' }, 
          },  ), 200);
