          ...
          <div class="home page">
            ...
            <div id="home-content" >
              ...
              <div class="ribbon mx-0 row justify-content-between pl-4 px-md-5 no-gutters" style="background-color:#b73a40;">
                ...
                <h2 class="my-auto mx-sm-5" style="font-size: 1em; font-weight: 300; letter-spacing: .05em;"><a class="link d-none d-sm-block" href="http://www.jakematthewrivers.com/">visit site </a></h2>
              </div>
                ...
                <div class="row my-5 pt-5 justify-content-around">
                  <div class="mx-auto col-12 col-lg-10 px-0 mt-2">
                      <p class="pt-5 pt-lg-0 text-left" style="font-size: 1.5em; font-weight: 100;">
                        <span class="font-weight-light text-left" style="color: white; font-size: 1.1em;"> 
                          TELLING A STORY
                        </span>
                        <br>
                        <span class="font-weight-light" style="color:white;">
